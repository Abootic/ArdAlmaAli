...
<!--==========================================================================================================================================-->
				...
				from products where state !=2 and company=:brand and name like :srch order by add_date desc";//get product from database
				$q=$con->prepare($sql);
				$q->execute(array("srch"=>$srch, "brand"=>$brandNo));
				if($q->rowcount())
				{
