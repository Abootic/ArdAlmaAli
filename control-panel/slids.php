...
<div class='col-sm-6 col-md-12'  >
        ...
        <button class='btn btn btn-block text-uppercase' style='border-style:solid;border-radius:10px; background-color:#1ba87c'
        ...
        <?php
                    ...
                    if ($slid1->rowcount()) {
                        foreach ($slid1->fetchall() as $s) {
                            ...
                            echo"<br><br><div class='col-sm-6 col-md-4' style='background-color:#04ba81
'><br>";
                            echo "<div  id='img'
                            style='border-style:solid;border-color:#fff; border-radius:5px;'  >";
                            echo"<img   class='card-img rounded-50 img-fluid' src='images/slids/$img' alt='$img'\>";
                            echo"</div>";
                            echo"<div style='font-family: fangsong;margin:10px' class='caption'>
							<p   dir='rtl' align='right'> 	$tilte </p>
							<p    align='right'>   $desc</p>
							<span>
							<a href='update_slides.php?action=update&id=$id1' class='btn btn-success btn-block text-uppercase' style='border-style:solid;border-radius:5px; background-color:#1ba87c'>
							تعديل</a
							></span>
